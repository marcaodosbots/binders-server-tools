...
const getLocalizedTexts = (lang, inviter) => {
    ...
    return {
        dm_title: isPtBr ? `Obrigado por me adicionar!` : `Thanks for adding me!`,
        ...
        channel_title: isPtBr ? `Obrigado pelo convite!` : `Thanks for the invite!`,
        ...
        generic_title: isPtBr ? `Olá, novo servidor!` : `Hello, new server!`,
